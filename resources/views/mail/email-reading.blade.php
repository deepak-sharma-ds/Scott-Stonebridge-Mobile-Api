...
<head>
    ...
    <title>{{ $product?->name ?? 'Your Psychic Email Reading' }}</title>
    <style>
        ...
        <tr>
            <td align="center" class="ss-wrapper" style="padding:24px 12px;">
                <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;width:100%;background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 4px 18px rgba(43,26,61,0.12);">
                    ...
                    <tr>
                        <td style="padding:0;">
                            <img src="{{ $headerImageUrl }}" alt="{{ $product?->name ?? 'Scott Stonebridge' }}" style="display:block;width:100%;max-width:640px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="ss-body" style="padding:36px 32px;">
                            ...
                            <div class="ss-reading" style="background:#faf7f2;border-left:4px solid #f5d97a;border-radius:0 6px 6px 0;padding:26px 28px;color:#2b1a3d;font-size:15px;line-height:1.75;white-space:pre-line;">{{ $readingBody }}</div>
