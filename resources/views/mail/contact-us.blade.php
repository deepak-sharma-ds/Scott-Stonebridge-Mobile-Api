                ...
                <tr>
                    <td style="padding:25px; color:#333333; font-size:14px; line-height:1.6;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin:15px 0; border-collapse:collapse;">
                            <tr>
                                <td style="padding:8px; background-color:#f9fafb; border:1px solid #e5e7eb; width:120px;">
                                    <strong>Name</strong>
                                </td>
                        ...
                        <div style="padding:12px; background-color:#f9fafb; border:1px solid #e5e7eb; border-radius:4px;">
                            {{ $custom_text }}
                        </div>
