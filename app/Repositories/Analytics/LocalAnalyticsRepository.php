...
{
    public function countDownloads(\DateTimeInterface $from = null, \DateTimeInterface $to = null)
    {
    ...
    public function downloadsByAudioId(\DateTimeInterface $from = null, \DateTimeInterface $to = null)
    {
        $q = AudioDownloadLog::query();
        if ($from) $q->where('downloaded_at', '>=', $from);
        if ($to) $q->where('downloaded_at', '<=', $to);
        return $q->select('audio_id', DB::raw('count(*) as total'))
            ->groupBy('audio_id')->orderByDesc('total')->get();
    }

    public function activeUsersCount(\DateTimeInterface $from = null, \DateTimeInterface $to = null)
    {
        $q = ApiLog::query();
    ...
    public function topSearches(\DateTimeInterface $from = null, $limit = 10, \DateTimeInterface $to = null)
    {
    ...
    public function wishlistTrends(\DateTimeInterface $from = null, $limit = 10, \DateTimeInterface $to = null)
    {
    ...
    public function bookingsCount(\DateTimeInterface $from = null, \DateTimeInterface $to = null)
    {
    ...
    public function audioSubscriptionPurchasesCount(\DateTimeInterface $from = null, \DateTimeInterface $to = null)
    {
